...
//        ]);
    ...
    {
        $itemModel = Yii::$app->modules[Config::MODULE_NAME]->entityFactory->getFullEntityModel($id, $item_id);
    ...
    {
        $itemModel = Yii::$app->modules[Config::MODULE_NAME]->entityFactory->getInstanceById($id);
