...
use common\modules\generator\gridviews\TaskGridViewClassGenerator;
use Yii;
...
class TaskGridViewClassFactory
{
    ...
    public static function get($grid_view_id, $generate = false)
    {
        ...
        if(class_exists($gridViewClass) && !$generate){
            ...
            if(TaskGridViewClassGenerator::generateFile($grid_view_id,'frontend\runtime\generated','pdb', Yii::$app->basePath.'/runtime/generated')) {
                return $gridViewClass;
            }
        }
    }
    ...
    {
        return TaskGridViewClassGenerator::generateFile($grid_view_id,'frontend\runtime\generated','pdb', Yii::$app->basePath.'/runtime/generated');
    }
    ...
    {
        return static::$namespace.'\\TaskGridView'.$gridView->id;
    }
}