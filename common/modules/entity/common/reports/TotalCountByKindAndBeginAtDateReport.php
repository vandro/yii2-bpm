...
class TotalCountByKindAndBeginAtDateReport extends Component
{
    protected $kinds;
    protected $years;
    protected $html = '';
    ...
    protected function rHeader()
    {
        ...
        $this->html .= 'Йиллар бўйича ОАВ фалият куриниши сифатида рўйхатга олинган ҳақида <br>';
