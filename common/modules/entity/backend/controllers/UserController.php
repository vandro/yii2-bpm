...
use common\modules\entity\common\models\UserSearch;
...
class UserController extends Controller
{
    ...
    {
        $arDepartments = [];
        $departments = Departments::find()->where(['organisation_id' => $id])->all();
        foreach($departments as $department){
            $arDepartments[] = ['value' => $department->id, 'label' => $department->title];
        }
        echo json_encode($arDepartments);
    }
}
