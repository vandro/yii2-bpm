...
use common\modules\entity\common\models\ActionHandlerLinkSearch;
    ...
    public function actions()
    {
        return [
            'create' => [
                ...
                'tab' => 2,
                'redirect_url' => 'nar-link/view',
                'modelClass' => ActionHandlerLink::className(),
                'parent_id_filed' => 'action_id',
            ],
            'update' => [
