...
<br>
    <p>
        <?= Html::a('Create Forms Rule', ['forms-rules/create', 'parent_id' => $model->id], ['class' => 'btn btn-success']) ?>
    </p>
            ...
            [
                ...
                'buttons'=>[
                    'view'=>function ($url, $model) {
                        return ActionColumnHelper::view($url,$model,'entity/forms-rules');
                    },
                    'update'=>function ($url, $model) {
                        return ActionColumnHelper::update($url,$model,'entity/forms-rules');
                    },
                    'delete'=>function ($url, $model) {
                        return ActionColumnHelper::delete($url,$model,'entity/forms-rules');
                    },
                ],
