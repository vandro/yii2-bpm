...
<div class="nodes-conditions-form">
    ...
    <?= $form->field($model, 'next_execution_type')->dropDownList(['action' => 'Action', 'condition' => 'Condition'], ['prompt' => 'Choose next execution type', 'onchange' => 'showNextExecutionType(this)']) ?>
